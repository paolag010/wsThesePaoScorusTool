...
public class MainFrame extends JFrame implements ActionListener {
	...
	FramesResults frames = new FramesResults();
	...
	{		
		...
		frames.showConfigurations(fmsConfs, "Configurations FM");
		...
		for (Map.Entry<String, Object[]> entry : resultsDerivation.entrySet()) {
			...
			frames.showTreeAJSMetrics((DefaultTreeModel)infoDerivation[0], (String)infoDerivation[1], entry.getKey(), infoMetrics);	
		}
	}
